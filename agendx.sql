...
--
-- Host: localhost    Database: agendx
-- ------------------------------------------------------
...
CREATE TABLE `appointments` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `appointments_professional_id_date_start_time_end_time_unique` (`professional_id`,`date`,`start_time`,`end_time`),
...
CREATE TABLE `availabilities` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `availabilities_professional_id_foreign` (`professional_id`),
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2026_02_08_003924_create_clients_table',2),(5,'2026_02_08_004122_create_professionals_table',3),(6,'2026_02_08_004253_create_availabilities_table',4),(13,'2026_02_08_004719_create_appointments_table',5);
...
-- Dump completed on 2026-02-28 15:30:10
