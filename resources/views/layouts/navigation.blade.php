<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('professionals')" :active="request()->routeIs('professionals')">
                Profissionais
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('availabilities')" :active="request()->routeIs('availabilities')">
                Disponibilidades
            </x-responsive-nav-link>
